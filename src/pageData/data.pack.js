...
export const hero = {
  title: "Готовая система письма для ваших исследований",
  description:
    "От поиска источников и организации ваших идей до готовых к публикации файлов с автоматичеки собранной библиографией",
  typeWriterText: [
    "на стероидах",
    "без неров",
    "как алгоритм",
...
export const about = {
  ...
  boxes: [
    ...
    {
      mainText: "Базу можно фильтровать по типам и темам контента",
      spanText: ["фильтровать по типам и темам"],
    },
    {
      padding: "0px",
      video: "/video/knowledge-base.mp4",
    },
  ],
};
...
export const aboutCourse = {
  ...
  boxes: [
    {
      mainText:
        "О том, как преодолеть п��опасть между чтением чужих и написанием своих публикаций с помощью системы заметок и инструментов",
      spanText: [
        "преодолеть пропасть между чтением",
        "и написанием",
        "публикаций",
      ],
    },
    {
      mainText: "Как делать готовые публикации в 2 раза быстрее",
...
export const results = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Научитесь пополнять папку с идеями и писать новые тексты в 2 раза быстрее",
      spanText: ["писать новые тексты в 2 раза быстрее"],
    },
    {
      mainText: "Подготовите черновик текста по вашей теме за месяц",
      spanText: ["черновик", "текста", "за месяц"],
    },
  ],
...
export const process = {
  ...
  boxes: [
    {
      mainText: "Смотрите 30 коротких видеоуроков, делаете домашние задания",
      spanText: ["30", "видеоуроков", "домашние задания"],
    },
    {
      mainText: "Еженедельно получаете письменную обратную связь преподавателя",
...
export const program = {
  ...
  boxes: [
    ...
    },
    {
      ...
      spanText: [""],
      artifact:
        "Литературная заметка, содержащая пересказ основных идей прочитанного, основные идеи из текста, а также ваши собственные идеи о прочитанном",
    },
    {
      ...
      spanText: [""],
      artifact:
        "3 перманентных заметки: с чужой идеей, со своей идеей, служебная (с понятием)",
    },
    {
  ...
  tariffs: [
    {
      ...
      features: [
        {
          mainText: "30 анимированных уроков по 2-5 минут + конспекты",
          spanText: "",
        },
        {
          mainText: "видео мастер-классы по каждому шагу системы:",
          spanText: "",
        },
        {
          mainText: "5 гайдов и подсказок",
          spanText: "",
        },
        {
          mainText: "домашние задания с чек-листами для самопроверки",
          spanText: "",
        },
        {
          mainText:
            "приложение для автоматической установки настройки нужных программ",
          spanText: "",
        },
        {
          mainText: "настроенное хранилище Obsidian с шаблонами и плагинами",
          spanText: "",
        },
        {
    ...
    },
    {
      ...
      price: "27 993 ₽",
      description:
        "Для тех, кто хочет освоить систему работ�� с текстами в комфортном темпе",
      features: [
        {
        ...
        {
          mainText: "фидбек по заданиям от куратора 2 раза в неделю",
          spanText: "",
        },
        {
          mainText: "5 гайдов и подсказок",
  ...
  reviewItems: [
    {
      ...
      data: {
        mainText:
          "Мощный курс. Сначала открывает мир Zettelkasten и очаровывает возможностями этой системы работы с текстом, а потом дает конкретный инструмент для собирания научных статей из коллекции заметок. Я поменял свои привычки в работе с литературой после этого курса, и пересказываю некоторые идеи коллегам.",
        spanText: [
          "Мощный курс",
          "дает конкретный инструмент для собирания научных статей из коллекции заметок",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        ...
        spanText: [
          "Ожидания мои оправдал: получилось написать, пусть и не целую статью, но её небольшую часть, ещё за время курса",
        ],
      },
    },
    {
      ...
      data: {
        mainText:
          "Валерий со своим инженерным подходом смог собрать любопытную связку инструментов для академической работы.",
...
export const requestForm = {
  ...
  boxes: [
    {
      mainText: "Укажите почту, на которую вы хотите получить библиотеку",
      spanText: ["Укажите почту"],
    },
    {
      mainText: "Спасибо! Проверьте почту — письмо придёт в течение 5 минут 🙌",
...
export const requestFormFree = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Спасибо! Проверьте почту — там чек и п��сьмо для создания личного кабинета. Пожалуйста, нажмите в письме «подтвердить email». К началу курса пришлём инструкции для старта, а также добавим в Telegram-чат. До встречи!",
      spanText: [
        "Проверьте почту ",
        "чек ",
        "создания личного кабинета",
        "нажмите в письме «подтвердить email»",
        "пришлём письмо с инструкциями",
        "добавим в Telegram-чат",
      ],
    },
  ],
  forms: [
...
export const faq = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer:
        "Оплатить можно российской или зарубежной картой. Если у вас не проходил оплата, напишите, пожалуйста, нам на почту.",
    },
    {
      question: "А я точно напишу текст после вашего курса?",
      answer:
        "Да, если будете выполнять задания, читать литературу и делать по ней заметки. Однако более простого пути, к сожалению, нет (разве что ChatGPT).",
    },
    /* {
