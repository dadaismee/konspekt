...
export const hero = {
  title: "Научитесь превращать прочитанное в сильные тексты",
  description: "Курс, где вы научитесь писать тексты в момент чтения источников — с помощью аннотаций и системы связанных заметок",
  //typeWriterText: ["на стероидах", "без неров", "как алгоритм", "as it should be"],
  buttonText: "Записаться на курс",
  //features: ["Онлайн-курс для студентов, аспирантов и исследователей «Система письма»"],
  ...
  tariffs: [
    ...
    //},
    {
      ...
      features: [
        ...
        {
          mainText: "возможность докупить фидбэк преподавателя",
        ...
        },
        {
          ...
          spanText: ["не нужно настраивать Obsidian, Zotero и Pandoc руками"],
        },
        {
          mainText: "(БОНУС) настроенная среда Obsidian:",
          spanText: ["структура папок, плагины и шаблоны + легко перенести существующие заметки"],
        },
        //{
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          spanText: ["первые две недели каждый день задание на 30-60 минут, вторые две недели — работа над текстом"],
        },
        {
        ...
        {
          mainText: "(БОНУС) 4 дополнительных гайда",
          spanText: ["по тайм-менеджменту для исследователей, оценке приоритета истоника и скорочтению"],
        },
        {
          mainText: "(БОНУС) видео-туториал по rga-fzf ",
          spanText: ["мгновенный и мощный поиска фраз по PDF, DOCX и другим форматам"],
        },
      ...
      timing: "1 месяц",
      startDate: "старт в июле",
      description: "Для тех, кто хочет быстро освоить и внедрить систему письма в практику"
    }, 
    {
      title: "С экспертом",
      name: "with-expert",
      ...
      timing: "1 месяц",
      startDate: "старт в июле",
      description: "Для тех, кто хочет решить прикладную задачу и/или перенять опыт эксперта",
      features: [
        {
        ...
        },
        {
          ...
          spanText: ["4 часовых созвона + чат для помощи с вашей задачей или текстом"],
        },
        {
          mainText: "доступ 12 месяцев",
          spanText: [""],
        },
      ],
    }, 
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Доступ к платформе откроется мгновенно на тарифе «Сам(а)». Про новые потоки расскажем отдельно. Если есть вопросы, пишите нам.",
