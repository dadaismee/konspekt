...
export const hero = {
  title: "«Система письма»: пошаговый алгоритм для PhD-гуманитариев",
...
export const audience = {
  ...
  boxes: [
    {
      mainText: "«продвинутые» магистранты: собрать источники и свои идеи для ВКР",
      spanText: ["«продвинутые» магистранты"],
    },
    {
      mainText: "студенты-бакалавры гуманитарных направлений: подготовиться к учёбе в магистратуре или на PhD",
      spanText: ["студенты-бакалавры гуманитарных направлений"],
    },
    {
      mainText: "PhD-исследователи, аспиранты гуманитарных и социальных наук: превратить беспорядок в систему и создать драфт",
      spanText: ["PhD-исследователи", "аспиранты гуманитарных", "социальных наук"],
    },
  ],
  videoData: [
    {
