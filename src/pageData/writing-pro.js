...
export const faq = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer: "Важно обладать базовой цифровой грамотностью: уметь устанавливать программы, пользоваться мессенджером Телеграм и облачным хранилищем вроде Google Drive. Всему остальному, нужному для создания базы заметок, мы научим. Самое главное — не бояться технических вещей и быть готовыми разобраться в них."
    },
    {
    ...
    },
    {
      ...
      answer:
        "В тарифе «Практика фокус — на формировании и закреплении навыков и быстром решение возникающих у студентов сложностей. Он подойдёт, если нужно как можно скорее упорядочить работу над текстами и начать писать. «Личный подойдёт, если хотите написать текст по своим источникам и точно дойти до конца или решить конкретную — связать нужные вам приложения, настроить воркфлоу сохранения идей из подкастов, понять как написать и где взять источники для пропоузала или похожие задачи.",
