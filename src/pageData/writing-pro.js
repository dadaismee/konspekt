...
export const hero = {
  ...
  title: "Готовая система для написания академических текстов",
  description: "Экономит 60% времени + помогает глубже понимать тексты + создавать больше оригинальных идей + автоматически собирать библиографию: без подписок и «облаков»",
