...
//
// : делайте заметки при чтении и связывайте их в Obsidian, чтобы легко создавать сильные тексты
//
export const hero = {
  title: "Постройте картотеку идей для ВКР, статей и диссертации",
  description: "Собственная сеть заметок, готовых к превращению в ваши тексты — мощное подспорье для учебы и академической карьеры",
...
export const about = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Как писать эссе и научные тексты стабильно и глубоко, а не в последний момент",
      spanText: ["стабильно и глубоко", "превращать их в", "тексты"],
    },
    {
      padding: "0px",
      video:
...
export const audience = {
  ...
  boxes: [
    {
      mainText: "студентам социально-гуманитарных направлений, чтобы писать эссе, статьи или диссертацию",
      spanText: ["студентам социально-гуманитарных направлений", "исследователям"],
    },
    {
      mainText: "исследователям, преподавателям и экспертам, чтобы превращать свою экспертизу в тексты и продукты",
      spanText: ["исследователям", "экспертам", "преподавателям"],
    },
    // {
  ...
  boxes: [
    {
      ...
      spanText: ["10+", "заметок", "готовых к вставке в ваши тексты"],
    },
    {
    ...
    },
    {
      ...
      spanText: [
        "Напишете", "мини-эссе", "в веб-журнале"
      ],
    },
  ],
...
export const pricing = {
  ...
  tariffs: [
    ...
    },
    {
      ...
      timing: "1 месяц",
      startDate: "старт 29 июня",
      description: "Для тех, кому важна обратная связь и возможность быстро внедрить систему в практику"
    }, 
    {
      title: "Личный",
      name: "expert",
      ...
      description: "Для тех, кому важна личная поддержка и возможность перенять опыт эксперта",
      features: [
        {
