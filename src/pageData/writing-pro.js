...
export const hero = {
  title: "Пошаговый алгоритм для PhD-исследователей: от хаоса к черновику за 4 недели",
  description: "Поможем упорядочить источники, вычленить идеи и связать их, чтобы ваши амбиции обрели форму текста — без тревоги",
  ...
  image: "/apps.png",
  buttonText: "Начать учиться 1 сентября",
...
export const audience = {
  ...
  boxes: [
    ...
    {
      mainText: "PhD-исследователи и аспиранты: выбраться из хаоса и понять, как создать качественный драфт",
...
export const pricing = {
  ...
  tariffs: [
    ...
    // },
    {
      ...
      buyButtonText: "Начать за 13 330 ₽",
    ...
    }, 
    {
      ...
      priceExpiry: "до 19 мая",
      buyButtonText: "Начать за 29 997 ₽",
      ...
      features: [
        ...
        {
          mainText: "индивидуальная работа с преподавателем",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 1 сентября. Если есть вопросы, напишите нам 💚",
      spanText: ["Старт потока — 1 сентября", "вопросы", "напишите"],
    },
    {
      mainText:
  ...
  asterisk: "*цена с рассрочкой на 3 месяца: можно оплатить по частям или целиком, даже зарубежной картой" 
