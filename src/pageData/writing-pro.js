export const hero = {
  title: "Курс, где вы научитесь превращать заметки на полях в готовые",
  typeWriterText: ["научные статьи", "научно-популярные тексты", "эссе"],
  description: "Интенсив по оптимизации работы над академическими текстам",
  buttonText: "Выбрать тариф",
  features: ["30 видеоуроков","8 онлайн-воркшопов", "1 месяц", "1 текст в портфолио"],
};
...
export const about = {
  ...
  boxes: [
    {
      mainText:
        "Как преодолеть пропасть между чтением чужих и письмом своих текстов",
...
export const audience = {
  ...
  boxes: [
    ...
    {
      mainText:
        "всем, кому нужен надёжный алгоритм создания научных и научно-популярных текстов",
      spanText: ["надёжный алгоритм создания ", "текстов"],
    },
  ],
};
...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "30 коротких видеоуроков и домашние задания с обратной связью",
      spanText: ["30", "видеоуроков", "домашние задания"],
    },
    {
      mainText:
        "Еженедельная часовая Q&A-сессия с преподавателем",
      spanText: ["Q&A-сессия с преподавателем"],
    },
    {
      mainText: "8 онлайн-воркшопов с групповой практикой и отработкой навыков на тарифе «Спринт»",
      spanText: ["8 онлайн-воркшопов", "на тарифе «Спринт»"]
    },
    {
      mainText: "",
      spanText: [""],
      steps: [
        {
          mainText: "1. Смотрите видеоуроки и выполняете задания",
          spanText: ["Смотрите видеоуроки", "выполняете задания"],
        },
        {
          mainText: "2. На воркшопах разбираем сложности и тренируемся в группах",
          spanText: ["разбираем сложности", "тренируемся в группах"],
        },
      ],
    },
  ],
  ...
  tariffs: [
    {
      ...
      features: [
        {
          mainText: "30 видеоуроков: короткие анимированные лекции и видеоинструкции без говорящих голов",
          spanText: ["30 видеоуроков:"],
        },
        {
          mainText: "Детальная обратная связь: домашние задания с личной письменной проверкой от Валерия Шевченко раз в неделю",
          spanText: ["Детальная обратная связь"],
        },
        {
          mainText: "Чат поддержки: доступ к сообществу «Конспектирующих»",
          spanText: ["Чат поддержки:"],
        },
        {
          mainText: "Еженедельные встречи: часовые Q&A-сессии с Валерием раз в неделю",
          spanText: ["Еженедельные встречи:"],
        },
        {
          mainText: "4 шаблона заметок: для быстрого старта с любым типом заметок",
          spanText: ["4 шаблона заметок:"],
        },
        {
          mainText: "В своём темпе: проходите курс в удобное время",
          spanText: ["В своём темпе:"],
        },
        {
          mainText: "Постоянные обновления: дополняем курс новыми видео каждый месяц",
          spanText: ["Постоянные обновления:"],
        },
        {
          mainText: "В любое время: присоединяйтесь, когда хотите — у курса нет даты старта",
          spanText: ["В любое время:"],
        },
        {
          mainText: "Доступ к материалам и встречам — 3 месяца: после — 1 490₽/мес",
          spanText: ["Доступ к материалам и встречам — 3 месяца:"],
        },
      ],
      price: "15 990 ₽",
    },
    {
      ...
      features: [
        {
          mainText: "Всё из «Основного тарифа»: видеоуроки, чат, шаблоны, встречи",
          spanText: ["Всё из «Основного тарифа»:"],
        },
        {
          mainText: "8 онлайн-воркшопов по 1 часу: отдельная группа и чат, где 2 раза в неделю делаем тщательно спроектированные групповые и индивидуальные практические задания, отрабатываем навыки и пишем текст",
          spanText: ["8 онлайн-воркшопов по 1 часу:"],
        },
        {
          mainText: "1 месяц: 2 воркшопа в неделю по понедельникам и четвергам в 19:00 (UTC+3)",
          spanText: ["1 месяц"],
        },
        {
          mainText: "17 июня: старт ближайшего спринта",
          spanText: ["17 июня:"],
        }
      ],
      price: "29 990 ₽",
...
export const requestFormBuy = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Старт — c 20 мая. Занятия — по понедельникам и четвергам c 19 до 20 МСК. Если есть вопросы, пишите на почту ниже.",
      spanText: ["c 20 мая.","по понедельникам и четвергам", "пишите на почту ниже."],
    },
    {
      mainText:
