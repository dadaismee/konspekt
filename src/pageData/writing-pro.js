...
export const problem = {
  ...
  boxes: [
    ...
    {
      mainText: "Тратите 80% времени на поиск и организацию знаний, а развитие своих идей и творчество уходит на второй план",
      // Нет понятных шагов и надёжной системы для перехода от чтения к собственным текстам — сейчас и через 5 лет?",
      spanText: ["80% времени на поиск и организацию знаний", "творчество уходит на второй план"]
    },
    // {
...
export const pricing = {
  ...
  tariffs: [
    ...
    }, 
    {
      ...
      name: "personal",
      price: "59 490 ₽",
      oldPrice: "или 23 330 ₽/мес*",
      buyButtonColor: "var(--accent)",
      priceExpiry: "до 19 мая",
      buyButtonText: "Начать бесплатно",
      timing: "1 месяц, 5 мест",
      startDate: "старт 3 ноября",
  ...
  asterisk: "*скидка 15 % до 16 октября при полной оплате. Также можно оплатить в рассрочку на 3 месяца без скидки" 
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Первый модуль — бесплатно. Начать можно прямо сейчас, а продолжить — со стартом потока, 3 ноября.",
