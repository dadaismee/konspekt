...
export const outcomes = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Использовать текстовый редако Obsidian для ведения картотеки идей",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Курс начнётся в июне, включая тариф «Сам(а)». Если есть вопросы, пишите нам.",
      spanText: ["Курс начнётся в&nbsp;июне", "Следующий поток", "январе 2025-го", "Доступ", "день старта", "мгновенно", "вопросы","пишите"],
    },
    {
      mainText:
...
export const faq = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer: "Активная часть курса длится 1 месяц, но доступ к материалам на платформе дольше — от 3 до 12 месяцев в зависимости от тарифа."
    },
    //{
