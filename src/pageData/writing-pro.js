...
export const results = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Подготовите черновик научной статьи или научно-популярного текста за месяц",
      spanText: [
...
export const process = {
  ...
  asterisk: "*зависит от выбранного тарифа, воркшопы — два раза в неделю"
};
...
export const requestForm = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Спасибо! К началу курса пришлём письмо с инструкциями и расписанием, а также добавим в Telegram-чат. До встречи!",
...
export const faq = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer:
        "«Курс» подходит для самостоятельного изучения в удобном темпе: вам будет доступна теория и инструкции по настройке системы на платформе. Этот тариф подойдёт, если вы хотите попробовать настроить систему и не можете посещать воркшопы. В нём нет отработки навыков в режиме реального времени и обратной связи от преподавателя. В «Лаборатории» фокус — на формировании и закреплении навыков. Этот тариф подойдёт, если вам важно как можно скорее и эффективнее упорядочить работу над своими текстами и начать писать.",
    },
  ],
};
