...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "Длится 1 месяц, состоит из 8 онлайн-воркшопов и платформы с уроками, видеоинструкциями, текстами и квизами",
      spanText: ["1 месяц", "8 онлайн-воркшопов", "платформы с уроками"],
    },
    {
      mainText:
    ...
    },
    {
      ...
      steps: [
        {
        mainText: "1. Перед занятиями изучаете нужную тему в базе знаний",
        spanText: ["изучаете нужную тему в базе знаний"],
        },
        {
        mainText: "2. На воркшопах учите друг друга и делаете задания в группах",
        spanText: ["учите друг друга и делаете задания в группах"],
        }
      ],
    },
  ],
...
export const requestForm = {
  ...
  boxes: [
    {
      mainText:
        "Второй поток будет в марте. Если есть вопросы, пишите на почту ниже.",
