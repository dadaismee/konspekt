export const hero = {
  ...
  buttonText: 'Начать учиться 7 ноября',
};
...
export const requestForm = {
  ...
  boxes: [
    {
      mainText:
        'Старт курса — 7 ноября. К началу курса пришлём всю информацию. Если есть вопросы, пишите на почту ниже.',
      spanText: ['Старт курса — 7 ноября', 'пишите на почту ниже.'],
    },
    {
      mainText:
