...
export const reviews = {
  ...
  reviewItems: [
    ...
    score: "5/10",
    data: {
      mainText: "Курс подойдет для тех, кто уже пишет статьи, публикуется, но делает это «по старинке». Фреймворк и инструменты, которые дают на курсе, позволят здорово оптимизировать работу и минимизировать рутину. Но важно быть «продвинутым пользователем>, минимум, быть готовым им стать.",
      spanText: ["Мощный курс"],
    },
  },
    {
