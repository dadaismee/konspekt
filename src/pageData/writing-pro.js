...
export const hero = {
  title: "Научитесь системно превращать чтение в сильные тексты",
  description: "Делайте заметки при чтении и связывайте их, чтобы легче создавать сильные идеи для ваших текстов",
