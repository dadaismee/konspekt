...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "Длится 1 месяц, состоит из 8 онлайн-воркшопов и платформы с уроками и видеоинструкциями, займёт 5 часов в неделю",
      spanText: ["1 месяц", "8 онлайн-воркшопов", "платформы с уроками", "5 часов в неделю"],
    },
    {
      mainText:
