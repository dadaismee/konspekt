...
export const pricing = {
  ...
  tariffs: [
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          spanText: ["сессии сфокусированной работы над заметками и материалами курса для обмена опытом"],
        },
        // {
    ...
    }, 
    {
      ...
      timing: "1 месяц",
      startDate: "старт 28 июля",
      description: "Если важна личная поддержка или нужно создать воркфлоу для вашего случая",
      features: [
        {
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 28 июля. Запишитесь в вейтлист или выберите тариф «Сам(а)». Если есть вопросы, напишите нам ❤️",
      spanText: ["Старт потока — 28 июля", "вопросы", "напишите"],
    },
    {
      mainText:
