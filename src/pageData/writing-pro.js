...
export const hero = {
  ...
  description: "Онлайн-курс о том, как делать из заметок на полях готовые тексты, чтобы больше никогда не сидеть перед пустым листом",
  typeWriterText: ["на стероидах", "без неров", "как алгоритм", "as it should be"],
  buttonText: "Начать учиться 25 июля",
