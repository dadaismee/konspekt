...
export const pricing = {
  ...
  asterisk: "*или 17 990 ₽, если вместе со своим напарником" 
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 30 сентября. Доступ к платформе откроется  в день старта. Если есть вопросы, пишите на почту ниже.",
      spanText: ["Старт ", "30 сентября", "Доступ", "в день старта", "вопросы","пишите на почту ниже."],
    },
    {
      mainText:
  ...
  asterisk: "*или 17 990 ₽, если идёте вдвоём со своим напарником" 
  //asterisk: "*Также есть рассрочка на 3 месяца — 6663 ₽/мес" 
  //asterisk: "*цена со скидкой 25%. Без неё — 19 990₽. Также есть рассрочка на 3 месяца — 6663 ₽/мес" 
};
  ...
  questions: [
    {
      ...
      answer:
        "Если совсем не писали, то нет, а если вы писали блог, студенчекское эссе, научную статью, план урока или что-то другое — курс вам подойдёт. Важно, что на курсе не будет совсем базовой информации о том, как писать, но будут советы по структуре, стилистике и стратегиях написания текстов.",
    },
    {
