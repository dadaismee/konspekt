...
export const hero = {
  ...
  description: "Курс, где вы создадите систему перевода заметок на полях в интересные читателям тексты",
  //typeWriterText: ["на стероидах", "без неров", "как алгоритм", "as it should be"],
  buttonText: "Начать учиться 30 сентября",
  features: ["30 видеоуроков", "4 онлайн-занятия", "1 месяц", "опубликованое мини-эссе"],
...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "Смотрите видеоуроки, делаете задания к дедлайнам, получаете обратную связь преподавателя",
      spanText: ["видеоуроки", "задания", "обратную связь преподавателя"],
    },
    {
      mainText:
        "Вместе с напарником из группы пишете и обсуждаете заметки для ваших эссе, которые мы опубликуем в конце курса",
      spanText: ["с напарником", "пишете и обсуждаете заметки для ваших эссе"],
    },
    {
      mainText:
        "Раз в неделю — часовое занятие с мини-лекцией, практикой работы с заметками и ответами на вопросы",
  ...
  tariffs: [
    {
      ...
      features: [
        {
          mainText: "30 видеоуроков и лонгрид:",
          spanText: ["анимированные видео по 2-5 минут и детальное введение в теорию и практику системного письма"],
        },
        {
        ...
        },
        {
          ...
          spanText: ["эссе от 300 до 1000 слов, опопубликованное в веб-журнале школы «Конспект»"],
        },
        {
        ...
        },
        {
          ...
          spanText: ["домашние задания, письменно провепяемые проеподавателем два раза в неделю"],
        },
        {
        ...
        // },
        {
          ...
          spanText: ["после — 1 990₽/мес, сообщество — бесплатно"],
        }
      ],
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 30 сентября. Доступ к платформе откроется  тогда же. Если есть вопросы, пишите на почту ниже.",
      spanText: ["Старт ", "30 сентября", "Доступ", "тогда же", "вопросы","пишите на почту ниже."],
    },
    {
      mainText:
  ...
  questions: [
    {
      ...
      answer:
        "Если совсем не писали, то нет, а если вы писали блог, студенчекское эссе, научную статью, план урока или что-то другое — курс вам подойдёт. Важно, что на курсе не будет базовой информации о структуре, стилистике и стратегиях написания текстов.",
    },
    {
