...
export const hero = {
  title: "Пошаговый алгоритм для исследователей: от хаоса к базе знаний и черновику за 4 недели",
  description: "Поможем упорядочить источники, вычленить из них идеи и связать их, чтобы ваши амбиции легче обретали форму текста",
...
export const results = {
  ...
  boxes: [
    {
      mainText:
        "Научитесь активному чтению: аннотировать источники, превращая пометки в ваш текст",
      spanText: 
        ["Научитесь активному чтению"],
    },
    {
      mainText: 
...
export const process = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Два раза в неделю — живые сессии: коворкинг с куратором и Q&A с преподавателем",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Первый модуль — бесплатно, можно начать сейчас. Старт потока — 1 сентября.",
  ...
  asterisk: "*после прохождения первого модуля курс можно оплатить по частям или целиком, даже зарубежной картой" 
