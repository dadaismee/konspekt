...
export const hero = {
  ...
  description: "Поможем перейти от хаоса диссертации к базе знаний и черновику за 4 недели с помощью системы заметок и приложений",
  ...
  teamMembers: [
    {
      ...
      regalia: [
        ...
        {
          mainText:
            "публиковался в Digital Landscape Architecture, Philosophy of the Social Sciences, «Логосе» и других журналах",
          spanText: ["Digital Landscape Architecture"],
        },
        {
          mainText: "преподавал в «Шанинке» и Школе Дизайна НИУ ВШЭ",
          spanText: ["«Шанинке»"],
        },
        {
