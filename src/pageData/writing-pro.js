export const hero = {
  ...
  description: "Практический курс продвинутых техник академического письма",
...
export const results = {
  ...
  boxes: [
    {
      mainText:
        "Создадите папку заметок с идеями, готовыми для вставки в ваши тексты*",
...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "30 анимированных видеоуроков, домашка, проверка кураторов",
      spanText: ["30", "видеоуроков", "проверка кураторов", "1 месяц"],
    },
    {
      mainText:
    ...
    {
      mainText: "8 онлайн-воркшопов с практикой и настройкой системы на тарифе «Спринт»",
  ...
  tariffs: [
    {
      ...
      features: [
        ...
        {
          mainText: "Письменная обратная связь преподавателя 1 раз в неделю",
    ...
    },
    {
      ...
      features: [
        ...
        {
          mainText: "Старт ближайшего потока — 20 мая",
          spanText: ["Старт", "20 мая"],
        }
      ],
      price: "19 990 ₽",
    },
...
export const requestFormBuy = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Старт «Спринта» — 20 мая. Если есть вопросы, пишите на почту ниже.",
      spanText: ["Старт «Спринта» — 20 мая.","пишите на почту ниже."],
    },
    {
      mainText:
