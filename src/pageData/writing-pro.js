...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 3 ноября. Выберите тариф и оставьте заявку — мы напишем вам к началу потока. Если есть вопросы, пишите нам.",
      spanText: ["Старт потока — 3 ноября", "Если есть вопросы", "пишите"],
    },
    {
      mainText:
