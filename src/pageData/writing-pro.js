...
export const hero = {
  ...
  description: "Поможем перейти от хаоса исследования и диссертации к базе знаний и черновику за 4 недели с помощью системы заметок и приложений",
