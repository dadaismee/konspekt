...
export const about = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Как стабильно формулировать новые идеи и превращать их в понятные и интересные тексты",
  ...
  reviewItems: [
    {
      ...
      data: {
        ...
        spanText: ["Курс помог мне переосмыслить подход к письму и чтению", "понравилось, что в курсе есть теория и практика", "Я стала использовать Zotero не только для создания списка литературы, но и чтения", "понравился подход Валерия", "работа в течение месяца прошла не зря", "я смогла написать десятистраничный текст для конференции"],
      },
    },
        {
      author: "Маша Волкова",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Доступ к платформе откроется в день старта курса или мгновенно на тарифе «Сам(а)». Если есть вопросы, пишите нам.",
