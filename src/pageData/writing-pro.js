...
export const hero = {
  title: "Система письма для учёбы, ВКР, статей и диссертации",
  description: "4-недельный курс, чтобы научиться превращать чтение в сильные тексты с картотекой заметок, Obsidian и Zotero",
  // description: "Учитесь писать научные тексты, начиная не с пустого листа, а с сети ваших заметок. ",
...
export const about = {
  ...
  boxes: [
    {
      mainText:
        "Как преодолеть пропасть между чтением чужих и написанием своих текстов с помощью системы — заметок, инструментов и автоматизаций",
      spanText: ["преодолеть пропасть между чтением", "написанием", "текстов"],
    },
    {
      mainText:
        "Как писать научные тексты стабильно и глубоко и вовремя",
      spanText: ["писать научные тексты", "стабильно"],
    },
    {
      padding: "0px",
      video:
...
export const audience = {
  ...
  boxes: [
    {
      mainText: "исследователи и постдоки: поставить осмысленные тексты на поток",
      spanText: ["исследователи", "постдоки"],
    },
    {
      mainText: "преподаватели и методологи: «вытащить» экспертизу из головы в учебные материалы, лонгриды и продукты",
      spanText: ["преподаватели", "методологи"],
    },
    {
      mainText: "студенты-гуманитарии: подготовиться к учёбе в магистратуре или PhD, написать эссе, статью и диссертацию",
      spanText: ["студенты-гуманитарии"],
    },
    // {
    //   mainText:
    //     "всем, кто много читает и хочет писать сильные тексты",
    //     // "всем, кто работает с источниками и хочет превращать их в растущую картотеку идей, чтобы писать сильные тексты",
    //   spanText: 
    //     ["читает", "хочет писать сильные тексты"],
    //     // ["кто работает с источниками", "хочет", "превращать их в", "картотеку идей", "писать", "тексты"],
    // },
  ],
};
...
export const results = {
  ...
  boxes: [
    {
      mainText:
        // "Напишете мини-эссе по выбранной теме из собранных за курс заметок",
        "Научитесь активному чтению: выделять и аннотировать тексты, превращая выделенное в ваш текст",
      spanText: 
        ["Научитесь активному чтению"],
    },
    {
      mainText: 
        "Готовая система приложений и шаблонов для ваших заметок — устанавливаете и начинаете работать",
      ...
      spanText: 
        ...
        ["Готовая система приложений"],
    },
    {
      mainText:
        // "Создадите 10+ заметок из прочитанного, готовых к вставке в ваши тексты*",
        "Сделаете 10+ заметок из прочитанного → мини-эссе → основа для ВКР или статьи*",
      spanText: ["10+", "заметок", "мини-эссе" ],
    },
  ],
  ...
  tariffs: [
    ...
    },
    {
      ...
      features: [
        ...
        {
          mainText: "4 часовых сессии с преподавателем",
          spanText: [""],
        },
        // {
        ...
        // },
        {
          ...
          spanText: ["тематические чаты и воркшопы от интересных гостей"],
        },
        {
      ...
      oldPrice: "29 990 ₽",
      priceExpiry: "до 19 мая",
      buyButtonText: "Записаться в лист ожидания",
      buyButtonColor: "var(--podlozhka)",
      timing: "1 месяц",
      startDate: "старт 28 июля",
      description: "Если важна обратная связь и быстрое внедрение системы в свою практику"
    }, 
    // {
    //   title: "Личный",
    //   name: "expert",
    ...
    //   description: "Для тех, кому важна личная поддержка или нужно решить сложный технический кейс",
    //   features: [
    //     {
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт «Практики» — 28 июля, продажи откроем позже. Выберите «Сам(а)» или запишитесь в лист ожидания. Если есть вопросы, напишите нам",
      spanText: ["Старт «Практики» — 28 июля", "вопросы", "напишите"],
    },
    {
      mainText:
    ...
    {
      mainText:
        "Спасибо! В течение двух недель откроем продажи и пришлём письмо. До связи! 🙌",
