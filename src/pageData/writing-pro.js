...
export const audience = {
  ...
  boxes: [
    ...
    {
      mainText: "авторам нон-фикшна, чтобы быстрее собрать нужный материал",
      spanText: ["авторам"],
    },
    {
      mainText:
...
export const outcomes = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Связывать заметки между собой и не бояться, что связи потеряются (потому что они не потеряются)",
    ...
    },
    {
      ...
      spanText: ["хранить статьи", "книги в вашей собственной библиотеке"],
      gridArea: 2
    },
    {
      mainText:
