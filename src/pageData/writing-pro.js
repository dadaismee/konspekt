export const hero = {
  ...
  buttonText: "Начать учиться 21 марта",
...
export const pricing = {
  ...
  tariffs: [
    {
      ...
      features: [
        {
          mainText: "— 15 уроков с квизами и видеоинструкциями*",
          spanText: ["15 уроков"],
        },
        {
  ...
  asterisk: "*материалы доступны два месяца с 11 марта, первый воркшоп — 14 марта"
};
