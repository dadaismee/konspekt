...
export const hero = {
  title: "Научитесь превращать чтение в черновики научных текстов",
  description: "Фиксируйте идеи во время чтения, связывайте их в настроенном Obsidian и формируйте собственную базу знаний, готовую к статьям и диссертации",
  //typeWriterText: ["на стероидах", "без неров", "как алгоритм", "as it should be"],
  features: ["«Система письма» — курс для аспирантов, исследователей и авторов нон-фикшн"],
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          spanText: ["проверка домашних заданий в неделю"],
        },
        {
