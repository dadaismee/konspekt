...
export const pricing = {
  ...
  tariffs: [
    ...
    //},
    {
      ...
      features: [
        {
          mainText: "30 видеоуроков по 2-5 минут",
          //spanText: ["+ 2 лонгрида и саммари уроков"],
          spanText: [""],
        },
        {
          mainText: "4 видео с мастер-классами",
          spanText: ["по всем шагам системы"],
        },
        {
          mainText: "5 гайдов и шпаргалок",
          spanText: ["по Obsidian, Zotero, нейросетям в исследованиях"],
        },
        {
          mainText: "15 домашних заданий",
          spanText: ["с чек-листами для самопроверки"],
        },
        {
          mainText: "Возможность докупить фидбэк",
          spanText: ["или перейти на другой тариф с доплатой"],
        },
        {
          mainText: "БОНУС — Автоматически настроенные приложения",
          spanText: ["Obsidian, Zotero и Pandoc"],
        },
        {
          mainText: "БОНУС — Настроенная среда Obsidian:",
          spanText: ["структура папок, плагины и шаблоны заметок"],
        },
        {
    ...
    },
    {
      ...
      features: [
        {
          mainText: "Всё из тарифа «Сам(а)», но с дедлайнами",
          spanText: [""],
        },
        {
    ...
    }, 
    {
      ...
      timing: "1 месяц",
      startDate: "старт в июле",
      description: "Для тех, кто хочет решить прикладную задачу или перенять опыт",
      features: [
        {
        ...
        },
        {
          ...
          spanText: ["4 часовых созвона + ведение вашего проекта или ведение текста до подачи в журнал или публикации"],
        },
        {
          mainText: "доступ к материалам и обновлениям курса 12 месяцев",
          spanText: [""],
        },
      ],
    }, 
