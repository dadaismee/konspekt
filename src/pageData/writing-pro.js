export const hero = {
  ...
  buttonText: 'Начать учиться 24 октября',
};
...
export const process = {
  ...
  asterisk:
    '*да, чтобы учиться на курсе, нужен аккаунт в Telegram — его нужно будет создать, если у вас его нет',
};
  ...
  questions: [
    {
      ...
      answer:
        'В теории да, но лучше иметь опыт написания научных статей или нон-фикшн текстов. На курсе не будет базы про академическое письмо, его структуру и стилистику.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Если вы пишете статью, связанную с социальными науками — социологией, социальной психологией, философией социальной науки или философией науки в целом — и хотите профессиональной консультации по содержанию и подготовке статьи к публикации.',
    },
  ],
};
