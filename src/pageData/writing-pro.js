...
export const results = {
  ...
  boxes: [
    ...
    {
      mainText: "Соберёте логический «скелет» нового текста и поймёте, как писать ваши следующие тексты",
      spanText: ["«скелет» нового текста"],
    },
    {
      mainText:
        "Настроите долговечный, устойчивый и удобный алгоритм быстрого создания публикаций",
      spanText: [
        "долговечный", "алгоритм", "создания публикаций",
      ],
    },
  ],
...
export const pricing = {
  ...
  tariffs: [
    {
      ...
      features: [
        ...
        // },
        {
          ...
          spanText: ["после — 1 990₽/мес, сообщество и встречи — бесплатно"],
        }
      ],
  ...
  asterisk: "*Также есть рассрочка на 3 месяца — 6633 ₽/мес" 
  //asterisk: "*цена со скидкой 25%. Без неё — 19 990₽. Также есть рассрочка на 3 месяца — 6633 ₽/мес" 
};
...
export const faq = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer: "Курс довольно технический, поэтому важно не бояться технических вещей и быть готовыми разобраться в них. Например, «покопаться» в настройках программы или поискать решение проблемы в интернете. Для этого важно обладать базовой цифровой грамотностью: уметь устанавливать программы, пользоваться мессенджером Телеграм и облачным хранилищем Google Drive, а также сервисом записи экрана Loom. Всему остальному, нужному для создания базы заметок, мы вас научим."
    },
    {
    ...
    },
    {
      ...
      answer: "Оплатить можно всю стоимость сразу российской или зарубежной картой. Также есть рассрочка на 3 месяца — период доступа к курсу, платёж составляет 6633.33 ₽/месяц. Если у вас не проходил оплата, напишите, пожалуйста, нам на почту."
    },
    {
