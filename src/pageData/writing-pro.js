...
export const hero = {
  title: "Пишите сильные тексты без хаоса",
  description: "Научитесь делать заметки на полях и собирать из них статьи, диссертации и другие тексты",
...
export const problem = {
  ...
  questions: [
    {
      question: "Тонете в сотнях PDF и не можете найти нужную цитату",
      answer:
        "пук",
      image: "/base_cover.png"
    },
    {
      question: "Делаете заметки, но они теряются — в блокнотах, в «облаке», в папках",
      answer:
        "пись",
      image: "/base_cover.png"
    },
        {
      question: "Тратите часы на поиск источников вместо того, чтобы писать текст",
      answer: "пись",
      image: "/base_cover.png"
    },
    {
      question: "Не можете начать писать текст из-за страха пустого листа",
      answer: "пись",
      image: "/base_cover.png"
    },
  ]
...
export const solution = {
  ...
  boxes: [
    {
      mainText:
        "Алгоритм «отжима» информации — от чтения и аннотирования через серию заметок",
      spanText: ["преодолеть пропасть между чтением", "написанием", "текстов"],
      smallImage: "/base_cover.png"
    },
    {
      mainText:
        "Как стабильно формулировать новые идеи и превращать их в увлекательные тексты",
