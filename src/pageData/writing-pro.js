...
export const hero = {
  ...
  buttonText: "Начать учиться 7 октября",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 7 октября. Доступ к платформе откроется  в день старта. Если есть вопросы, пишите на почту ниже.",
      spanText: ["Старт ", "7 октября", "Доступ", "в день старта", "вопросы","пишите на почту ниже."],
    },
    {
      mainText:
