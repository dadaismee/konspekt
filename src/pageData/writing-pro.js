...
export const pricing = {
  ...
  asterisk: "*рассрочка на 3 и 6 месяцев для «Практики» и «Личного» соответственно"
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Старт потока — 10 ноября. Выберите тариф и оставьте заявку — мы напишем вам к началу потока. Если есть вопросы, пишите нам.",
      spanText: ["Старт потока — 10 ноября", "Если есть вопросы", "пишите"],
    },
    {
      mainText:
