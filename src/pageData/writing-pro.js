  ...
  tariffs: [
    ...
    //},
    {
      ...
      features: [
        ...
        {
          mainText: "(БОНУС) настроенные приложения",
          spanText: ["наша программа сама скачает, установит и свяжет между собой Obsidian, Zotero и Pandoc на macOS или Windows"],
        },
        {
          mainText: "(БОНУС) настроенная среда Obsidian",
