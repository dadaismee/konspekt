...
export const hero = {
  title: "Академическое письмо на стероидах",
  description: "Однодневный практический интенив по настройке «конвейера» письма ",
  typeWriterText: ["на стероидах", "без неров", "как алгоритм", "as it should be"],
  buttonText: "Записаться на 8 августа",
  features: ["30 видеоуроков", "1 месяц", "4 встречи с преподавателем", "4 шаблона заметок"],
...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "Смотрите видеоуроки, делаете домашние задания, получаете письменную обратную связь",
      spanText: ["видеоуроки", "домашние задания", "обратную связь"],
    },
    {
      mainText:
        "Раз в неделю встречаетесь с группой и преподавателем на звонке, чтобы задать вопросы",
      spanText: ["Раз в неделю встречаетесь с группой и преподавателем"],
    },
    {
      padding: "0px",
      image:
  ...
  tariffs: [
    {
      ...
      features: [
        ...
        {
          mainText: "Чат c Random Coffee: ",
          spanText: ["доступ к сообществу «Конспектирующих» и новые знакомства"],
        },
        {
