...
export const hero = {
  ...
  description: "Экономит 60% времени и помогает глубже понимать тексты, системно создавать оригинальные идеи и автоматически собирать библиографию — без подписок и «облаков»",
...
export const program = {
  ...
  boxes: [
    ...
    // },
    {
      mainText: "Не терять источники и важные идеи из них",
      subText:
        "Вы научитесь пользоваться Zotero, ResearchRabbit, Google Scholar для поиска и хранения источников, а также узнаете устройство системы письма из гайдов, которые мы встроили в систему",
      results: [
    ...
    // },
    {
      mainText: "Сохранять идеи из источников после первого прочтения",
      subText:
        "Разберётесь с приложением Obsidian, научитесль делать конспекты источников с вашими мыслями и отсылками — из гайдов и коворкинг-сессий",
      spanText: [""],
      results: [
        // "→ сделаете структурированный конспект источника"
      ]
    },
    {
      mainText: "Находить новые идеи в связях между заметками",
      subText:
        "Начнёте вычленять идеи из конспектов и оформлять их в заметки, готовые к вставке в будущие тексты + связывать заметки друг с другом и обнаруживать инсайты",
      results: [
    ...
    {
      mainText: "Не тратить вечера на ручное составление библиографии",
      subText:
        "Вместо пустого листа у вас будут «скелеты» (аутлайны) новых текстов из заметок c идеями, для которых сможете автоматически собирать библиографию с Pandoc",
      results: [
        // "→ 5 заметок с идеями",
...
export const pricing = {
  ...
  tariffs: [
    ...
    // },
    {
      ...
      features: [
        {
          mainText: "настроенные приложения + поддержка, чтобы всё заработало",
          spanText: ["наш скрипт установит и свяжет Obsidian, Zotero и Pandoc на macOS или Windows, а если нужна будет помощь, созвонимся и решим проблему"],
        },
        {
        ...
        {
          mainText: "доступ навсегда — без подписок",
          spanText: [""],
        },
        {
          mainText: "ваши данные — у вас на компьютере, без «облаков»",
          spanText: [""],
        },
        {
          mainText: "(БОНУС) коворкинги с куратором и группой по субботам",
          spanText: ["опциональные сессии для сфокусированной совместной работы и обмена опытом с коллегами-исследователями"],
        },
        {
          mainText: "(БОНУС) чат + сообщество выпускников «Конспекта»",
          spanText: [""],
        },
        // {
        //   mainText: "30 анимированных уроков по 2-5 минут",
      ...
      timing: "",
      startDate: "",
      description: "Готовая система — устанавливается в два клика и треубет 1-2 часа для старта"
    }, 
    {
      title: "Сопровождение",
      name: "personal",
      ...
      description: "Индивидуальная настройка системы и синхронизации + гарантированный набросок текста по вашей теме",
      features: [
        {
          mainText: "всё из «Системы»",
          spanText: [""],
        },
        {
        ...
        {
          mainText: "честный возврат", 
          spanText: ["вернём деньги, если не сделаете набросок нового текста по результатам месяца совместной работы с куратором"],
        },
        // {
  ...
  asterisk: "*рассрочка на 3 и 6 месяцев для «Системы» и «Сопровождения» соответственно"
};
...
export const reviews = {
  ...
  // },
  title: "Что говорят выпускники курса →",
  reviewItems: [
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "После оплаты пришлём на почту ссылку с приложением и инструкцией по его установке. Если есть вопросы, напишите нам ↓",
