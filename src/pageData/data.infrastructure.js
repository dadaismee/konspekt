...
export const hero = {
  ...
  title: "Конспект ОС",
  description: "Инфраструктура для академической работы, которая экономит 60% времени, помогает системно создавать оригинальные идеи и автоматизировать рутину",
