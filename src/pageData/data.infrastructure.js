...
export const process = {
  ...
  boxes: [
    {
      mainText:
        "Смотрите видеоуроки, делаете задания и получаете обратную связь преподавателя раз в неделю в течение месяца",
      spanText: ["видеоуроки", "задания", "обратную связь преподавателя", "в течение месяца"],
    },
    {
      mainText:
        "Наше приложение установит и свяжет нужные программы, а настроенное хранилище поможет шаблонами и шпаргалками для быстрого старта",
      spanText: ["приложение установит и свяжет нужные программы", "настроенное хранилище"],
    },
    {
      padding: "0px",
...
export const program = {
  title: "Как курс изменит вашу жизнь",
  type: "list",
  boxes: [
    // {
    ...
    // },
    {
      mainText: "Перестанете терять источники и важные идеи из них",
      subText:
        "Вы научитесь пользоваться Zotero, ResearchRabbit, Google Scholar для поиска и хранения источников, а также узнаете устройство системы письма",
      results: [
    ...
    // },
    {
      mainText: "Начнёте сохранять идеи из источников с первого прочтения",
      subText:
        "Разберётесь с приложением Obsidian, научитесль делать конспекты источников с вашими мыслями и отсылками",
      spanText: [""],
      results: [
    ...
    {
      mainText: "Будете находить новые идеи в связях между книгами и статьями",
      subText:
        "Начнёте вычленять идеи из конспектов и оформлять их в заметки, готовые к вставке в будущие тексты, а также связывать заметки друг с другом, чтобы обнаруживать инсайты",
      results: [
    ...
    {
      mainText: "Перестанете тратить вечера на ручное составление библиографии",
      subText:
...
export const pricing = {
  ...
  tariffs: [
    ...
    // },
    {
      ...
      features: [
        {
          mainText: "30 видеоуроков и заданий",
          spanText: ["+ 2 авторских лонгрида"],
        },
        {
          mainText: "письменная обратная связь от преподавателя",
          spanText: ["1 раз в неделю в течение месяца"],
        },
        {
          mainText: "настроенные приложения",
          spanText: ["наш скрипт установит и свяжет Obsidian, Zotero и Pandoc на macOS или Windows"],
        },
        {
          mainText: "настроенная среда Obsidian для работы",
          spanText: ["всё для удобной работы в одном месте — шаблоны заметок и граф для связей между идеями"],
        },
        {
          mainText: "17 гайдов и шпаргалок",
          spanText: ["вместо отдельных курсов по Obsidian, Zotero и системам письма"],
        },
        {
          mainText: "доступ к материалам курса 6 месяцев",
          spanText: [""],
        },
        // {
      ...
      description: "Подходит занятым людям: комфортный темп + обратная связь от преподавателя"
    }, 
    {
      title: "Сопровождение",
      name: "personal",
      ...
      description: "Индивидуальная настройка системы + сопровождение до готового наброска текста по вашей теме",
      features: [
        {
        ...
        {
          mainText: "доступ к материалам курса 12 месяцев",
          spanText: [""],
        },
        {
...
export const faq = {
  ...
  questions: [
...

    {
      ...
      answer: "Оплатить можно российской или зарубежной картой. Если у вас не проходит оплата, напишите, пожалуйста, нам в Телеграм."
    },
    {
