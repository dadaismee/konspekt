...
export const hero = {
  ...
  title: "Система для академической работы",
  description: "Инфраструктура, которая экономит 60% времени, помогает системно создавать оригинальные идеи и автоматизировать рутину",
