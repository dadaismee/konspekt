...
export const program = {
  ...
  boxes: [
    ...
    // },
    {
      mainText: "Не перечитывать источники и сохранять идеи",
      subText:
    ...
    {
      mainText: "Находить инсайты в связях между заметками",
      subText:
    ...
    },
    {
      ...
      subText:
        "Сделаете «скелет» текста из заметок c идеями и автоматически соберёте библиографию с Pandoc → сделаете готовый к публикации документ",
      results: [
        // "→ 5 заметок с идеями",
  ...
  tariffs: [
    ...
    // },
    {
      ...
      features: [
        ...
        {
          mainText: "доступ навсегда — никаких подписок",
          spanText: [""],
        },
        {
          mainText: "все данные хранятся у вас на компьютере — никаких «облаков»",
          spanText: [""],
        },
        // {
        //   mainText: "30 анимированных уроков по 2-5 минут",
    ...
    }, 
    {
      ...
      timing: "1 месяц, 5 мест в месяц",
      startDate: "старт 10 ноября",
      description: "Настроите систему индивидуально с куратором и напишете набросок текста по своей теме",
      features: [
        {
