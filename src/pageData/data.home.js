...
export const about = {
  problem: "О чём курс",
  promise: "Наша цель — помочь вам создать персональную систему работы с мыслями, которая останется с вами навсегда. Для начала работы: мы предлагаем курсы — готовые и проверенные решения. Для углубления: мы проводим мастер-классы и интенсивы. Для создания нового: мы ведём лабораторию — сообщество практиков, которые вместе исследуют и создают инструменты будущего.",
  audience: "Для всех, кто работает со знанием — от студентов и аспирантов до экспертов и исследователей",
};
