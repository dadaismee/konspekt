export const hero = {
  title: "Перестаньте терять знания и время",
  typeWriterText: [
    "начиная тексты с нуля",
    "правя отчёты вручную",
    "когда уходит сотрудник",
    "путаясь в базах знаний",
  ],
  // typeWriterText: [
  ...
  //   ],
  // title: "Перестаньте терять знания и время",
  description: "Помогаем исследователям, R&D-командам и бизнесам не терять знания и быстрее принимать решения: строим инфраструктуры данных и автоматизируем ручные процессы",
  // video: "/video/landing.mp4",
  image: "/courses.notes.png",
  buttonText: "Обсудить проект",
  to: "#contact",
  smallButtonText: "Курсы для исследователей",
