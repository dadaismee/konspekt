export const hero = {
  title: "Читать и думать что понимаешь — не то же самое, что читать и понимать",
  typeWriterText: [
    "Интерактивный инструмент за 2-3 часа",
    "10-20 собственных формулировок",
    "Навык навсегда",
  ],
  description: "Не курс — инструмент. Вы работаете со своим текстом, и из него рождаются ваши мысли",
  image: "/courses.notes.png",
  buttonText: "Попробовать за 4 990 ₽",
  to: "/read-and-understand#pricing",
  smallButtonText: "Для команд и бизнесов",
  smallButtonTo: "#courses",
};
...
export const problem = {
  ...
  boxes: [
    {
      mainText: "Новые отчёты делаются с нуля: ошибки в форматировании, потеря важной информации, копипаст и зависимость от навыков сотрудника",
      spanText: ["отчёты делаются с нуля", "потеря важной информации"]
    },
    {
      mainText: "Базы знаний — кладбища идей: сложно найти нужное, сложно обновлять и онбордить сотрудников",
      spanText: ["сложно найти нужное"]
    },
    {
      mainText: "Вместе с сотрудниками уходит и их экспертиза, и команда/бизнес теряет ценность",
      spanText: ["уходит", "экспертиза"]
    },
    {
      mainText: "В исследовании много источников и данных, идеи теряются — сложно увидеть картину целиком и быстрее принимать решения",
      spanText: ["много источников", "идеи теряются"]
...
export const audience = {
  ...
  boxes: [
    {
      mainText: "«продвинутые» магистранты любых направлений: создать «рельсы», чтобы написать ВКР",
      spanText: ["«продвинутые» магистранты любых направлений"],
    },
    {
      mainText: "абитуриенты вузов и студенты-бакалавры : понять логику академического письма и подготовиться к учёбе",
...
export const process = {
  ...
  boxes: [
    ...
    {
      mainText:
        "Два раза в неделю — живые сессии: коворкинг и Q&A с преподавателем",
      spanText: ["Два раза в неделю", "лайв-занятия", "коворкинг", "Q&A"],
    },
    // {
    //   mainText:
    //     "На «личном» тарифе — персональная работа с преподавателем: чат и созвоны",
...
export const program = {
  ...
  boxes: [
    ...
    // },
    {
      mainText: "Новые отчёты, статьи и диссертации начинаются с нуля",
      subText:
        "Отчёты делают руками, копируют из разных мест, части теряются, форматирование в Word — отдельная боль, ",
      results: [
        "→ мы настраиваем автоматическую сборку уже отформатированных отчётов по вашим источникам"
      ],
    ...
    // },
    {
      mainText: "Знания теряются и не переиспользуются",
      subText:
        "Базы знаний не помогают увидеть структуру знаний — идеи теряются,  ",
      spanText: [""],
      results: [
        "→ структурированный конспект источника"]
    },
    {
      mainText: "Вместе с сотрудником уходит часть экспертизы",
      subText:
        "",
      results: [
...
export const solutions = {
  ...
  boxes: [
    ...
    // },
    {
      mainText: "Настройка воспроизводимой инфраструктуры отчётов",
      subText:
        "Убираем боль ручной сборки документов, разрозненных файлов и форматов.",
      results: [
       "1. Анализируем текущие процессы создания отчётов и деловых/исследовательских документов",
        "2. Настраиваем поток, где ваши заметки и данные становятся источником для автоматической сборки — docx/pdf/веб",
        "3. Убираем ручное копирование, хаос поиска в разных местах и зависимость от навыков отдельных сотрудников",
        "📍 Результат: отчёты собираются автоматически — нужно лишь писать содержание"
      ],
      // "Научитесь пользоваться референс-менеджером Zotero и сервисами ResearchRabbit, Google Scholar и Hypothesis для поиска источников и выделения важных мыслей в PDF-файлах и на веб-страницах, а также настроите свою библиотеку в Zotero",
      spanText: [""],
    },
    ...
    // },
    {
      mainText: "Аудит и проектирование управления знаниями",
      subText:
        "Помогаем выявить узкие места, где знания теряются, и построить устойчивую систему их накопления и (пере)использования.",
      spanText: [""],
      results: [
        "1. Изучаем, как у вас создаются, хранятся и переиспользуются знания",
        "2. Даём карту процессов + рекомендации по оптимизации: как фиксировать идеи, как связывать их между собой, как управлять потоками знаний",
        "3. Если нужно, выделяем проджект-менеджера, чтобы внедрить рекомендации в работу",
        "📍 Результат: экспертиза прирастает, решения принимаются быстрее и чётче.",
      ]
    },
    // {
    //   mainText: "Готовый текст из черновика с идеями",
  ...
  tariffs: [
    ...
    // },
    {
      ...
      features: [
        ...
        {
          mainText: "4 Q&A-сессии с преподавателем",
      ...
      price: "29 990 ₽",
      oldPrice: "или 9 997 ₽/мес*",
      priceExpiry: "до 20 мая",
      buyButtonText: "Начать бесплатно",
      buyButtonColor: "var(--podlozhka)",
      timing: "1 месяц — 20 мест",
      startDate: "старт 1 сентября",
      description: "Освоите алгоритм и напишете черновик по тренировочным источникам — это проще, чем сразу читать свои"
    },
    {
      ...
      startDate: "старт 1 сентября",
      description: "Напишете черновик по своей теме: будете осваивать алгоритм и читать свои источники с нашей поддержкой",
      features: [
        {
  ...
  teamMembers: [
    {
      ...
      regalia: [
        {
          mainText:
            "философ, исследователь устойчивого цифрового дизайна",
          spanText: [""],
        },
        {
    ...
    },
    {
      ...
      regalia: [
        ...
        {
          mainText:
            "выпускница 7-го потока «Системы письма»",
...
export const requestFormBuy = {
  ...
  boxes: [
    {
      mainText:
        "Первый модуль — бесплатно. Можно начать прямо сейчас. Старт потока — 1 сентября.",
...
export const contact = {
  title: "Опишите ваш запрос в письме",
