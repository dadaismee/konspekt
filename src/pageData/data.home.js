export const links = [
  ...
  // {
  //   name: 'для университетов и бизнеса',
  //   url: '/#courses',
  // },
  // {
  //   name: 'журнал',
...
export const hero = {
  title: "Простое и устойчивое создание знаний",
  typeWriterText: ["без сложных программ", "без потери данных", "на ваших условиях", ""],
  description: "Помогаем компаниям и исследователям внедрить простые и надёжные способы создания со знания и текстов: без потерь данных и платных подписок",
