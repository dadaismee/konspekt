...
// export const hero = {
//   title: "«Система письма»: пошаговый алгоритм создания знания для аспирантов и PhD",
//   description: "Поможем перейти от хаоса исследования к базе знаний и черновику за 4 недели с помощью системы заметок и приложений",
...
//
// export const about = {
//   problem: "Исследователи и студенты тратят 80% времени на поиск и организацию информации, а не на развитие своих идей и создание новых знаний. Вы наверняка много читаете, но забываете важные цитаты. И каждый новый текст начинаете с нуля, теряясь в черновиках и файлах.",
//   promise: "Единый тщательно спроектированный рабочий процесс и инфраструктура, поддерживающая и направляющая на каждом этапе:", 
//   audience: "Для PhD-студентов и исследователей, которые:  "
// }
